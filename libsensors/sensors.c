...
static const struct sensor_t sS7SensorList[] =
{
        { "GS ST 3-axis Accelerometer",
                "ST Microelectronics",
        ...
        { "Temp sensor",
                ...
                SENSOR_TYPE_TEMPERATURE, 2000.0f, 1.0f, 0.5f, 0, { } },
...
*/
    *list = sS7SensorList;
    return ARRAY_SIZE(/*sTaosLIS302SensorList*/ sS7SensorList);
}
